...
def get_token(username, password):
    url = "https://agtech.pythonanywhere.com/api/token-auth/"
...
def submit(competition_url, username, password, dataframe):
    ...
    # API 엔드포인트
    url = (
        f"https://agtech.pythonanywhere.com/api/competitions/submit/{competition_url}/"
    )
...
def download_competition_files(
    ...
    if use_competition_url:
        target_url = f"https://agtech.pythonanywhere.com/competitions/{url}/files/"
